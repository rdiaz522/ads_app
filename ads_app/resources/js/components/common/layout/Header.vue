    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                <span class="d-none d-lg-block">Amy's Dress Shop</span>
            </a>
    ...
    methods: {
        ...
        toggleSidebar() {
            ...
            this.on("click", ".toggle-sidebar-btn", function (e) {
                me.select("body").classList.toggle("toggle-sidebar");
            });
        },

        toggleSearchBar() {
            const me = this;
            this.on("click", ".search-bar-toggle", function (e) {
                me.select(".search-bar").classList.toggle("search-bar-show");
            });
        },
